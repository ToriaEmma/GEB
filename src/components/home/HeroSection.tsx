...
export const HeroSection = () => {
  ...
  return (
    <section className="relative w-full min-h-screen bg-white pt-2 sm:pt-4 px-2 sm:px-4 md:px-6 lg:px-8 pb-2 sm:pb-4 md:pb-6 lg:pb-8">

      <div className="max-w-[1440px] mx-auto relative h-[85vh] sm:h-[80vh] md:h-[90vh] bg-white rounded-[32px] sm:rounded-[40px] shadow-2xl overflow-hidden p-1.5 sm:p-2 md:p-3 border border-gray-100">
        
        {/* Floating Integrated Menu */}
        <div className="absolute top-8 left-1/2 -translate-x-1/2 z-30 hidden xl:block">
        ...
        {/* RE-IMPLEMENTING WITH THE USER'S PREFERRED MASK LOGIC FOR THE BENTO LOOK */}
        <div className="absolute inset-2 md:inset-3 z-0">
            <div className="w-full h-full bg-[#050A18] rounded-[32px] overflow-hidden relative">
                ...
                {/* CONTENT AREA */}
                <div className="absolute inset-0 z-10 flex flex-col justify-center xl:justify-end p-6 pb-24 md:p-20">
                    {/* MAIN CONTENT TEXT */}
                ...
                {/* MASKING OVERLAYS TO CREATE BENTO CUTOUTS */}
                {/* Top Left Notch (Logo) */}
                <div className="absolute top-0 left-0 w-[180px] sm:w-[240px] md:w-[300px] h-16 sm:h-20 md:h-24 bg-white rounded-br-[32px] sm:rounded-br-[40px] z-20">
                ...
                {/* Top Right Notch (Icons) */}
                <div className="absolute top-0 right-0 h-16 sm:h-20 md:h-24 bg-white rounded-bl-[32px] sm:rounded-bl-[40px] z-20 p-1.5 sm:p-2 md:p-3">
                ...
                {/* Bottom Right Notch (AI Card) - THE DETACHED LOOK */}
                <div className="absolute bottom-0 right-0 w-full max-w-[240px] xs:max-w-[280px] sm:max-w-[320px] md:max-w-[420px] bg-white rounded-tl-[32px] sm:rounded-tl-[40px] z-20 p-5 xs:p-6 sm:p-8 md:p-12 shadow-[-20px_-20px_60px_rgba(0,0,0,0.1)]">
