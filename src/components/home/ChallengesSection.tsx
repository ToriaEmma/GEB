...
const challenges = [
    {
        title: "L'impasse normative",
        description: "La complexité des standards internationaux freine souvent l'ambition des entreprises locales et leur accès aux marchés mondiaux.",
        icon: <Warning size={32} weight="duotone" className="text-[#4471c4]" />,
        accent: "bg-[#4471c4]/5",
        border: "border-[#4471c4]/10"
    },
    {
        title: "L'instabilité opérationnelle",
        description: "Des processus non structurés entraînent une perte de qualité constante et une stagnation de la performance globale.",
    ...
    },
    {
        ...
        description: "L'absence d'une certification ISO reconnue limite la crédibilité et bloque l'accès aux appels d'offres stratégiques.",
                ...
                <div className="mb-16 md:mb-20">
                    ...
                    >
                        ...
                        <h2 className="font-heading font-black text-5xl md:text-7xl lg:text-[100px] leading-[0.85] tracking-tighter text-white uppercase w-full text-left">
                            À qui s’adressent <br className="hidden md:block" />
                            <span className="text-[#2D3047]">Nos services.</span>
                        </h2>
                    </motion.div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-5 lg:gap-6 items-stretch">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <h3 className="font-heading font-bold text-2xl text-white mb-2">Entreprises</h3>
                            <p className="font-body text-white/50 text-base leading-tight">
                                de précision dans l'accompagnement normatif.
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <div className="md:col-span-4 relative group">
                        ...
                        >
                             ...
                             <div className="flex -space-x-4 mt-6">
                                {[
                                    { icon: <Stethoscope size={24} weight="duotone" className="text-white" />, label: "Santé" },
                                    { icon: <GraduationCap size={24} weight="duotone" className="text-white" />, label: "Éducation" },
                                    { icon: <Scales size={24} weight="duotone" className="text-white" />, label: "Justice" },
                                    { icon: <Bank size={24} weight="duotone" className="text-white" />, label: "Finance" },
                                ].map((item, i) => (
                            ...
                            <div className="text-white mb-4">
                                ...
                                <div className="mt-2">
                                    <h3 className="font-heading font-bold text-2xl leading-tight text-white">Institutions Publiques</h3>
                                    <p className="font-body text-white/50 text-base font-medium mt-1">
                                        de fluidification des processus.
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="md:col-span-4 flex flex-col gap-5 lg:gap-6">
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="font-heading font-bold text-xl text-white">Responsables</h3>
                                <p className="font-body text-white/40 text-sm leading-tight mt-1">
                                    processus automatisés et maîtrisés.
                                </p>
                            </div>
                        </motion.div>
                        ...
                        >
                             ...
                             <div className="flex items-center gap-4 relative z-10">
                                ...
                                <div className="text-white/60 text-xs uppercase tracking-widest leading-tight">
                                    semaines <br /> de moyenne de <br /> déploiement.
                                </div>
                            </div>
                            
                            <div className="relative z-10">
                                <h3 className="font-heading font-bold text-xl text-white">Entrepreneurs</h3>
                                <p className="font-body text-white/40 text-xs">Visionnaires du changement.</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
