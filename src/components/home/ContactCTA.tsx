        ...
        <section className="py-16 md:py-20 bg-[#4471c4] w-full">
            <div className="max-w-[1240px] mx-auto px-5 sm:px-8">
              ...
              <h2 className="font-heading font-black text-3xl md:text-5xl text-white leading-[1.1] tracking-tighter mb-6">
                {t("partenaire_croissance")} <br />
                <span className="text-[#2D3047]">{t("croissance_normative_title")}</span>
              </h2>
                        <button className="bg-[#2D3047] text-white px-8 py-4 rounded-2xl flex items-center gap-6 group hover:bg-white hover:text-[#4471c4] transition-all duration-500">
                            <span className="font-heading font-bold uppercase text-xs tracking-widest">{t("prendre_rdv_cta")}</span>
                    ...
                    <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        >
                            ...
                            <div>
                                <p className="font-heading font-bold text-sm text-white">{t("telephone_label")}</p>
                        ...
                        <motion.div 
                            ...
                            className="bg-[#2D3047] p-6 rounded-[40px] flex flex-col gap-4 text-white"
                        >
