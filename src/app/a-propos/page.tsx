    ...
    return (
        <main className="min-h-screen pt-32 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
            ...
            >
                ...
                <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tight mb-8">À Propos de MEB</h1>
                <p className="text-lg text-gray-500 max-w-2xl leading-relaxed">
                    Best Experts Group (MEB) est un cabinet d'audit et de conseil stratégique dédié à l'excellence opérationnelle.
